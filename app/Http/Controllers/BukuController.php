...
class BukuController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($request->hasFile('foto')) {
            ...
            $file->storeAs('public/foto', $filename); // Menyimpan file di dalam direktori 'storage/app/public/foto'
            $input['foto'] = $filename;
        }
        ...
        if ($request->hasFile('file')) {
            ...
            $filename = time() . '_' . $file->getClientOriginalName();
            $file->storeAs('public/file', $filename); // Menyimpan file di dalam direktori 'storage/app/public/foto'
            $input['file'] = $filename;
        }
   ...
   if ($request->hasFile('foto')) {
            ...
            if ($buku->foto) {
                \Storage::delete('public/foto/' . $buku->foto);
            }
        }
